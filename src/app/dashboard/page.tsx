...
export default function WorkerDashboard() {
  ...
  // Interactive Liquid Glass Bending, Stretching & Swiping physics
  useEffect(() => {
    const cards = document.querySelectorAll<HTMLElement>('.glass-card, .liquid-glass-card');
    ...
    cards.forEach((card) => {
      ...
      const handleMove = (clientX: number, clientY: number) => {
        ...
        // Bending angles
        const tiltX = -Math.max(-14, Math.min(14, (dy / (rect.height / 2)) * 12 + swipeDy * 0.05));
