                ...
                return (
                  <div className="flex flex-wrap items-center gap-2.5 mt-4 pt-3.5 border-t border-[rgba(255,255,255,0.08)]">
                    ...
                    <button
                      ...
                      className={`quick-preset-btn quick-preset-btn-indigo ${isThisMonth ? 'active' : ''}`}
                    >
                    ...
                    <button
                      ...
                      className={`quick-preset-btn quick-preset-btn-purple ${isLastMonth ? 'active' : ''}`}
                    >
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button
                      ...
                      className={`quick-preset-btn quick-preset-btn-teal ${isLast30Days ? 'active' : ''}`}
                    >
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                        <line x1="16" y1="2" x2="16" y2="6" />
