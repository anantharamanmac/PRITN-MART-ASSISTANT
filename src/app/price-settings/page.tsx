...
export default function PriceSettingsPage() {
  ...
  const handleAddMaterial = () => {
    ...
    const val = typeof newMaterialRate === 'number' ? newMaterialRate : 250;
    setRates((prev) => ({
      ...prev,
      materials: {
        ...prev.materials,
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '1.5rem 1rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.25rem' }}>
          ...
          <div className="card-glass" style={{ padding: '1.25rem', borderRadius: '16px', border: '1px solid var(--border)', background: 'var(--bg-surface)' }}>
            ...
            <p style={{ margin: '0 0 1rem 0', fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
              Extra rate per piece added when Shorts are included in the order.
            </p>

            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem', background: 'var(--bg-main)', padding: '0.75rem 1rem', borderRadius: '10px', border: '1px solid var(--border)' }}>
              <div>
                <span style={{ fontSize: '0.9rem', fontWeight: 800, color: 'var(--text-primary)' }}>Shorts Rate per Piece</span>
                <span style={{ display: 'block', fontSize: '0.73rem', color: 'var(--text-secondary)' }}>Added to unit rate if &apos;Include Shorts&apos; is checked</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
