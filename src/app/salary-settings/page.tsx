            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="text-xs text-secondary leading-relaxed bg-white/5 p-3 rounded-lg border border-white/5 flex items-start gap-2">
                  ...
                  <span><strong>Note:</strong> Limiting cycle starts to the 1st - 28th ensures your payroll periods remain stable and consistent across all months of the year, including February. Days 29, 30, and 31 are disabled.</span>
                </div>
              </div>
            </div>
          </div>
